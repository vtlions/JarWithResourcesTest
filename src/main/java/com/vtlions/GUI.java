...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		URL urlPicture = getClass().getClassLoader().getResource("pudgejar.png");
		...
		InputStream in = getClass().getResourceAsStream("inside.txt");
		...
		JLabel labelPathURL2 = new JLabel(getClass().getResourceAsStream("inside.txt").toString());
